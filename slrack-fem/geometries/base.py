...
class BaseSystem:
    ...
    def add_beam_profile(self, model: Model, params: BeamProfileParams) -> BeamProfile:
        ...
        cross_section = CrossSection(cs.A, cs.Iy, cs.Iz, cs.J, 0.0)
...
CS_W146 = CrossSectionParams(
    8.22 * M2_PER_CM2, 215.51 * M4_PER_CM4, 53.02 * M4_PER_CM4, 268.53 * M4_PER_CM4
)
CS_SB_150_62_18 = CrossSectionParams(
    5.11 * M2_PER_CM2, 178.58 * M4_PER_CM4, 22.25 * M4_PER_CM4, 200.83 * M4_PER_CM4
)
